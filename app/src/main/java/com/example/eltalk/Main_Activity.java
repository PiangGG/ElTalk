...
public class Main_Activity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerToggle = new ActionBarDrawerToggle(this,
                /* host Activity */mDrawerLayout,
                /* DrawerLayout objectR.drawable.ic_drawer,
                /* nav drawer icon to replace 'Up' caret */R.string.drawer_open,
                /* "open drawer" description */R.string.drawer_close  //*/* "close drawer" description */
         );
        ...
        public void onClick(View view) {
            switch (view.getId()) {
                ...
                case R.id.open_expandable_list_button:
                    Intent intent = new Intent(Main_Activity.this,ExpandableListTestActivity.class);
